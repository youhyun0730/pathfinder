  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 to-purple-600 relative overflow-hidden">
      ...
      <div className="text-center text-white relative z-10">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 tracking-wider px-4" style={{ fontFamily: 'system-ui, -apple-system, sans-serif', letterSpacing: '0.15em', textShadow: '0 0 30px rgba(255,255,255,0.5), 0 0 60px rgba(139,92,246,0.3)' }}>
          PATHFINDER
        </h1>
        <p className="text-xl mb-8">あなたの成長を可視化するスキルツリー</p>
